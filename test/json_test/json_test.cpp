...
char*jsonfiles2[8] =
{
	"C:/Users/Anming/Desktop/rapidjson-0.11/rapidjson/bin/data/webapp.json",
	"D:/json.file/test0-u.json",
	"",
	"D:/json.file/test3-u.json", ///   46k
	"D:/json.file/test4-u.json", ///  138k
	"D:/json.file/test5-u.json", ///  484k
	"D:/json.file/test6-u.json", /// 2238k
	"D:/json.file/test7-u.json", /// 1147k
};
char*jsonfiles1[8] =
{
	"C:/Users/Anming/Desktop/rapidjson-0.11/rapidjson/bin/data/webapp.json",
	"D:/json.file/test0.json",
	"",
	"D:/json.file/test3.json", ///   46k
	"D:/json.file/test4.json", ///  138k
	"D:/json.file/test5.json", ///  484k
	"D:/json.file/test6.json", /// 2238k
	"D:/json.file/test7.json", /// 1147k
};
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//{
	{
		...
		JSONObject const& dd = jb.AsObject();
		int cccc;
		GET_INT_VALUE(dd,L"frameid",cccc);
		JSONObject::const_iterator uu = dd.find(L"frameid");
		std::wstring sss = uu->second->AsString();
