...
struct win_debug_print_string
{
	void operator()(char const* str)
	{
		OutputDebugStringA(str);
	}
	void operator()(wchar_t const* str)
	{
...
struct win_debug
#ifdef _DEBUG
	: ox::str::print_ref<win_debug_print_string,good_buffer<char[512]>>
#else
	: ox::str::print_ref<void,void>
#endif
{
	win_debug()
#ifdef _DEBUG
		: ox::str::print_ref<win_debug_print_string,good_buffer<char[512]>>(win_debug_print_string())
#else
		: ox::str::print_ref<void,void>(0)
#endif
	{}
};
